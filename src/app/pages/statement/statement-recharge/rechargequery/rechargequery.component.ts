...
@Component({
  selector: 'app-rechargequery',
  templateUrl: './rechargequery.component.html',
  styleUrls: ['./rechargequery.component.css']
})
export class RechargequeryComponent implements OnInit {
