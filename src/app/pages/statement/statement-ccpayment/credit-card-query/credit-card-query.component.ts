...
@Component({
  selector: 'app-credit-card-query',
  templateUrl: './credit-card-query.component.html',
  styleUrls: ['./credit-card-query.component.css']
})
export class CreditCardQueryComponent implements OnInit {
  sno: any;
  myTextarea:any;
  queryList:any;
  ...
  this._auth.postdata(formdata,config.statement.ccquery).subscribe((res: any) => {   
