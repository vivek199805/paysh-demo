...
@Component({
  selector: 'app-walletquery',
  templateUrl: './walletquery.component.html',
  styleUrls: ['./walletquery.component.css']
})
export class WalletqueryComponent implements OnInit {
  sno: any;
  myTextarea:any;
  queryList:any;
  ...
  this._auth.postdata(formdata,config.statement.walletquery).subscribe((res: any) => {   
