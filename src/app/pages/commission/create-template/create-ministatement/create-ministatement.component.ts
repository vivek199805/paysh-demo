...
@Component({
  selector: 'app-create-ministatement',
  templateUrl: './create-ministatement.component.html',
  styleUrls: ['./create-ministatement.component.css']
})
export class CreateMinistatementComponent implements OnInit {
  data: any = null;
  filterDt: any = [{
    operatorName: '0',
    operatorid: '0',
