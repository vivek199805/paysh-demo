...
@Component({
  selector: 'app-create-paytm-wallet',
  templateUrl: './create-paytm-wallet.component.html',
  styleUrls: ['./create-paytm-wallet.component.css']
})
export class CreatePaytmWalletComponent implements OnInit {
  data: any = null;
  filterDt: any = [{
    operatorName: '0',
    operatorid: '0',
