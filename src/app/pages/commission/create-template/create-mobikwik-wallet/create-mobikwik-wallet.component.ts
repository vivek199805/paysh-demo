...
@Component({
  selector: 'app-create-mobikwik-wallet',
  templateUrl: './create-mobikwik-wallet.component.html',
  styleUrls: ['./create-mobikwik-wallet.component.css']
})
export class CreateMobikwikWalletComponent implements OnInit {
  data: any = null;
  filterDt: any = [{
    operatorName: '0',
    operatorid: '0',
