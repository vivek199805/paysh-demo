...
@Component({
  selector: 'app-comm-icici-deposit',
  templateUrl: './comm-icici-deposit.component.html',
  styleUrls: ['./comm-icici-deposit.component.css']
})
export class CommIciciDepositComponent implements OnInit {
 userAutoComData: any;
